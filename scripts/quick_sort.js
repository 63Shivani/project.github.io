...
function quick_partition (start, end)
{
    ...
    div_update(divs[start],div_sizes[start],"moccasin");//Color update
        ...
        for(var j =start + 1; j <= end ; j++ )
        {
            ...
            if (div_sizes[ j ] < piv)
            {
                ...
                div_update(divs[i],div_sizes[i],"deepskyblue");//Height update
                div_update(divs[j],div_sizes[j],"deepskyblue");//Height update
    ...
    div_update(divs[start],div_sizes[start],"lightcoral");//Height update
